(function ($) {
  ...
  //On Click Open photo Block
  $(document).on("click", ".photo-block, .menu-item.photo", function () {
    $(".content-blocks").removeClass("showx");
    $(".content-blocks.photo").addClass("showx");
    $(".menu-item").removeClass("active");
    $(".menu-item.photo").addClass("active");
  });
  ...
  //On Click Close photo Post And Project Details
